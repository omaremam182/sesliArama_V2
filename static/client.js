...
const socket = new WebSocket("ws://localhost:5001"); // localde test için bu kullanılacak.
...
const div_element = document.getElementById("userIdInput");
const userIdInput= div_element.getAttribute("data-id");
...
startCallButton.addEventListener("click", async () => {
  ...
  // console.log(userIdInput.valueOf())
